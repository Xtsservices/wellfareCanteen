    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.loggedOutContainer}>
          <Image
            source={{uri: 'https://cdn-icons-png.freepik.com/256/1077/1077114.png'}}
    ...
    <SafeAreaView style={styles.container}>
        ...
        <View style={styles.profileCard}>
          <View style={styles.profileHeader}>
            <View style={styles.avatarContainer}>
              <Image
                source={{uri: 'https://cdn-icons-png.freepik.com/256/3135/3135715.png'}}
                style={styles.avatar}
              />
            ...
            <View style={styles.profileInfo}>
              ...
              <Text style={styles.profilePhone}>
                {userProfile?.phoneNumber ? formatPhoneNumber(userProfile.phoneNumber) : 'No phone number'}
              </Text>
        ...
        <View style={styles.menuContainer}>
          ...
          {menuItems.map((item) => (
            <TouchableOpacity
              ...
              <Image
                source={{uri: 'https://cdn-icons-png.freepik.com/256/318/318476.png'}}
      ...
      <View style={styles.bottomContainer}>
        <TouchableOpacity onPress={confirmLogout} style={styles.logoutButton}>
          <Image
            source={{uri: 'https://cdn-icons-png.freepik.com/256/1828/1828490.png'}}
